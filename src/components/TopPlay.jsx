...
const TopChartCard = ({ song, i, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  <div className={`w-full flex flex-row items-center hover:bg-[#981AB2] ${activeSong?.title === song?.title ? 'bg-[#b700dd]' : 'bg-transparent'} py-2 p-4 rounded-lg cursor-pointer mb-2`}>
